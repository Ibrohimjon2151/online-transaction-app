...
public final class AuthController implements AuthControllerInt {
  ...
  @PostMapping("/verify")
  @Override
  public ResponseEntity<ApiResponse> verifySmsCode(@RequestBody SmsPhoneNumberDto smsDto, HttpServletResponse httpServletResponse) {
    ApiResponse response = userService.verifySmsCodeEnableUser(smsDto, httpServletResponse);
